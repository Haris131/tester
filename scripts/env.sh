...
export HOST_BUN_VERSION="${HOST_BUN_VERSION:-1.3.14}"
...
export OPENCODE_VERSION="${OPENCODE_VERSION:-1.17.15}"
export OPENTUI_COMMIT="${OPENTUI_COMMIT:-5803b2cfa2942c45a3aedbb3601754e27f2cdc68}"
...
echo "OpenTui commit:   ${OPENTUI_COMMIT}"
